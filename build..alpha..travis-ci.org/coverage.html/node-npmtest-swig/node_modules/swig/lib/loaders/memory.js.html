...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-swig/node_modules/swig/lib/loaders/memory.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-swig/node_modules/swig/lib/loaders/memory.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-swig/node_modules/swig/lib/loaders/</a> &#187; memory.js</div>
</div>
<div class="body">
 ...
 */
module.exports = <span class="fstat-no" title="function not covered" >function (mapping, basepath) {</span>
<span class="cstat-no" title="statement not covered" >  var ret = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  basepath = (basepath) ? path.normalize(basepath) : null;</span>
&nbsp;
  /**
   ...
   * @return {string}
   */
<span class="cstat-no" title="statement not covered" >  ret.resolve = <span class="fstat-no" title="function not covered" >function (to, from) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (basepath) {</span>
<span class="cstat-no" title="statement not covered" >      from = basepath;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      from = (from) ? path.dirname(from) : '/';</span>
    }
<span class="cstat-no" title="statement not covered" >    return path.resolve(from, to);</span>
  };
&nbsp;
  /**
   ...
   */
<span class="cstat-no" title="statement not covered" >  ret.load = <span class="fstat-no" title="function not covered" >function (pathname, cb) {</span></span>
<span class="cstat-no" title="statement not covered" >    var src, paths;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    paths = [pathname, pathname.replace(/^(\/|\\)/, '')];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    src = mapping[paths[0]] || mapping[paths[1]];</span>
<span class="cstat-no" title="statement not covered" >    if (!src) {</span>
<span class="cstat-no" title="statement not covered" >      utils.throwError('Unable to find template "' + pathname + '".');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (cb) {</span>
<span class="cstat-no" title="statement not covered" >      cb(null, src);</span>
